use crate::domain::{
    AccountState, Address, ConflictInfo, Hash, StateError, StateProof, StorageKey, StorageProof,
    StorageValue, TransactionAccessPattern,
};
...
pub trait StateManagementApi: Send + Sync {
    ...
    fn get_balance(&self, address: Address, block_number: Option<u64>) -> Result<u128, StateError>;

    fn get_nonce(&self, address: Address, block_number: Option<u64>) -> Result<u64, StateError>;
